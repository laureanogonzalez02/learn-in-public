...
Git ofrece una forma de proponer cambios en un repositorio sin ser su propietario, llamada `Pull Request` Permite colaborar y solicitar que tus modificaciones sean revisadas e integradas al proyecto. El objetivo de este ejercicio es crear tu primer `Pull Request`. [Aquí un video de 12 min explicando pull requests](https://www.youtube.com/watch?v=_NrSWLQsDL4).
